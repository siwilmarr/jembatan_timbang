export async function exportTransactionsToPdf(transactions, filename = "riwayat-timbang") {
  try {
    // Load libraries dynamically on client-side to prevent SSR and loading issues
